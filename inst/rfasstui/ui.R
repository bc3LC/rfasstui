                          ...
                          (
                            ...
                            ("graphVar",  "Choose Output Variables:",
                              list('Precursors emissions' = list('BC emissions'="emissions_bc",'NH3 emissions'="emissions_nh3",'NMVOC emissions'="emissions_nmvoc",
                                   ...
                                   'Health impact' = list("Premature deaths due to PM25" = 'health_deaths_pm25', "Premature deaths due to O3" = 'health_deaths_o3',
                                                          "Premature deaths Total" = 'health_deaths_total'),
                                   'Agricultural impact' = list("Relative yield loss"='agriculture_ryl_mi', "Production loss"='agriculture_prod_loss',
                                                                "Revenue loss"='agriculture_rev_loss')),
                              multiple = T, selected = "health_deaths_total")
                          ),
                        )
                      ),
                      uiOutput("customScenarioSelector1", class = "output-vars"),
